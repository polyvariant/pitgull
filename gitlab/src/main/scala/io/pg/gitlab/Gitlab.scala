...
object Gitlab {
  ...
  def sttpInstance[F[_]: Logger: MonadThrow](
    ...
    new Gitlab[F] {
      ...
      private def listMRApprovalRules(
        projectId: Long,
        mergeRequestIid: Long
      ): F[List[ApprovalRule]] =
      ...
      private def setMrRuleApprovals(
        projectId: Long,
        mergeRequestIid: Long,
        ruleId: Long,
        amount: Int
      ...
      private def getMrApprovals(
        projectId: Long,
        mergeRequestIid: Long
      ): F[MergeRequestApprovals] =
        runInfallibleEndpoint(GitlabEndpoints.getMergeRequestApprovals)
          .apply((projectId, mergeRequestIid))

      private def setMrApprovals(
        projectId: Long,
        mergeRequestIid: Long,
        amount: Int
      ): F[Unit] =
...
object GitlabEndpoints {
  ...
  val acceptMergeRequest: Endpoint[
    (
      Long,
      Long
    ),
  ...
  val rebaseMergeRequest: Endpoint[
    (
      Long,
      Long
    ),
  ...
  val getMergeRequestApprovals: Endpoint[
    (
      Long,
      Long
    ),
  ...
  val setMergeRequestApprovals: Endpoint[
    (
      Long,
      Long,
      Int
  ...
  val listMRApprovaRules: Endpoint[
    (
      Long,
      Long
    ),
  ...
  val setMRRuleApprovalRequirement: Endpoint[
    (
      Long,
      Long,
      Long,
  ...
  object transport {
    ...
    final case class MergeRequestApprovals(
