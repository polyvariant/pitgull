  ...
  project
    ...
    .settings(
      ...
      libraryDependencies ++= List(
        ...
        "com.softwaremill.sttp.tapir" %% "tapir-json-circe" % "0.16.11",
        "com.softwaremill.sttp.tapir" %% "tapir-http4s-server" % "0.16.11",
        "com.softwaremill.sttp.tapir" %% "tapir-sttp-client" % "0.16.11",
