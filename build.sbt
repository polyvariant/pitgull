...
val pitgull =
  project
    ...
    .settings(
      ...
      libraryDependencies ++= List(
        "com.softwaremill.sttp.tapir" %% "tapir-core" % "0.17.5",
        "com.softwaremill.sttp.tapir" %% "tapir-json-circe" % "0.17.5",
        "com.softwaremill.sttp.tapir" %% "tapir-http4s-server" % "0.17.5",
        "com.softwaremill.sttp.tapir" %% "tapir-sttp-client" % "0.17.5",
